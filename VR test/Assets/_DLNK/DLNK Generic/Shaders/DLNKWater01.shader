    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float2 sceneUVs = float2(1,grabSign)*i.screenPos.xy*0.5+0.5 + (float3(node_7340.rg,0.0)*node_9396*_Refraction*i.normalDir).rg;
