...
// Specular:
            ...
            diffuseColor = DiffuseAndSpecularFromMetallic( diffuseColor, saturate(lerp((_TopMetallic*node_4283),(dot(_MetallicGlossMap_var.rgb,float3(0.3,0.59,0.11))*_Metallic),_InvertTopBottom_var)), specularColor, specularMonochrome );
