...
Shader "DLNK/FX/AdvancedLeaves" {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 node_7435 = _Time + _TimeEditor;
            float2 node_8341 = ((node_7435.r*_WorldNoiseVelocity)*float2(mul(_Object2World, v.vertex).r,mul(_Object2World, v.vertex).b));
